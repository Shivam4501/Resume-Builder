import { Briefcase, Loader2, Plus, Sparkles, Trash2, User } from 'lucide-react'
                ...
                {data.map((experience, index)=>(
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        <div className='flex justify-between items-start'>
                            ...
                            <button onClick={()=> removeExperience(index)} className='text-red-50 hover:text-red-700 transition-colors'>
                        ...
                        <div className='space-y-2'>
                            <div className='flex items-center justify-between'>
                                ...
                                <button onClick={()=>generateDescription(index)} disabled={generatingIndex === index || !experience.position || !experience.company} className='flex items-center gap-1 px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disables:opacity-50'>
