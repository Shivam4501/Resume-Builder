import { BriefcaseBusiness, Linkedin, Mail, MapPin, User, Phone, Globe } from 'lucide-react'
        ...
        <div>
            ...
            <div className='flex items-center gap-2'>
                <label>
                    {data.image ? (
                        <img
                            src={data.image instanceof File ? URL.createObjectURL(data.image) : data.image} // ✅ FIX 3
                            alt='user-image'
                    ...
                    <div className=' flex flex-col gap-1 pl-4 text-sm'>
                        ...
                        <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                            ...
                            <div className='w-9 h-5 bg-slate-300 rounded-full peer peer-checked:bg-green-600 transition-colors duration-200'>
                                ...
                                <span className="dot absolute left-1 top-1 w-3 h-3 bg-white rounded-full transform transition-transform peer-checked:translate-x-4"></span>
